...
const img = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTkspTGDaYI0SloxfqGWTJMZYniyE8q9oqahw&usqp=CAU"
                ...
                <Toolbar className="header_padding">
                    ...
                    <span className='pr-3'><img src={img} alt="" height="50" width='50'
                     style={{borderRadius:"999px", objectFit: "cover", cursor: "pointer" }} 
                      /></span>
                        <span className='pr-2 mt-1' style={{color:"#b0dd36"}}><h4>Admin Panel</h4></span>
