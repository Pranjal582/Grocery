          ...
          renderCell: (params) => {
            return (
              <div className="productListItem">
                <img className="productListImg" src={params.row.img} alt="" style={{marginRight: "10px" , width:"70px",  }} />
                {params.row.name}
              </div>
            );
          },
        ...
        },
        {
                ...
                renderCell: (params) => {
                  return (
                    <>
                      <button 
                      style={{margin: "10px",backgroundColor: "green", color:"#fff"}}
                      className="productListEdit" onClick={handleClickOpen} >Edit</button>
                      <DeleteOutlineOutlinedIcon
                       style={{margin: "10px",backgroundColor: "red", color:"#fff", borderRadius: "50%",  cursor:"pointer"}}
