    ...
    <>
     <ComplainHolder>
        ...
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod ad quas cupiditate perspiciatis vero inventore nihil debitis accusantium voluptas hic.</p>
            ...
            <button style={{backgroundColor : 'red', color :'#fff',borderRadius:"4px" }}>Suspend </button>
            <button style={{backgroundColor : '#f7a56d', color :'#fff',borderRadius:"4px"}}>Send Warning </button>
